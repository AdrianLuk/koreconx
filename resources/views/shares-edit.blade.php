    ...
    <div class="container">
        ...
        <form action="/shares/{{ $share->id }}" method="post">
            ...
            <div class="form-group">
                ...
                <input name="company_name" type="text" class="form-control" id="name" placeholder="Company Name" value="{{ $share->company_name }}" required>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" name="price" id="price" value="{{ $share->price }}">
                </div>
                <div class="form-group col-md-2">
                    ...
                    <input class="form-control" type="number" min="1" name="quantity" id="quantity" value="{{ $share->quantity }}">
                </div>
                <div class="form-group col-md-2">
                    <label for="total_investment" class="form-control-label text-uppercase font-weight-bold">Total Investment($)</label>
                    <input id="total_investment" name="total_investment" class="form-control text-center" type="text" readonly value="2482.63064">
                </div>
            </div>
            <div class="form-group">
